 ...
 */
public class GinModuleBuilder extends AbstractBuilder<GinModuleBuilder> {

    private String mainPackage;

    @Inject
    public GinModuleBuilder() {
        super();
        builder = this;
    }
    ...
    @Nonnull
    public GinModuleBuilder mainPackage(@Nonnull String mainPackage) {
