 ...
 */
public class InjectorBuilder extends AbstractBuilder<InjectorBuilder> {
    ...
    @Nonnull
    public InjectorBuilder mainPackage(@Nonnull String mainPackage) {
        this.mainPackage = mainPackage;
        return this;
    }

    @Nonnull
    public InjectorBuilder editorName(@Nonnull String editorName) {
