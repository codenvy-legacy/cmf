...
/**
 * The main class for generating GWT editor.
 *
 * @author Andrey Plotnikov
 */
public class GeneratorUtility {
    /**
     * Generate GWT editor code form given configuration.
     *
     * @param baseDir
     *         root folder that contains editor configuration
     */
    public static void generate(@Nonnull String baseDir) {
