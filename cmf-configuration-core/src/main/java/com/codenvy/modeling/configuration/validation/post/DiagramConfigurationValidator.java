 ...
 */
public class DiagramConfigurationValidator extends AbstractConfigurationValidator {

    public DiagramConfigurationValidator(@Nonnull ConfigurationKeeper configurationKeeper) {
