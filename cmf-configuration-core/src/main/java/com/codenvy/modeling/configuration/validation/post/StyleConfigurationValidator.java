 ...
 */
public class StyleConfigurationValidator extends AbstractConfigurationValidator {

    public StyleConfigurationValidator(@Nonnull ConfigurationKeeper configurationKeeper) {
