 ...
 */
public class EditorConfigurationValidator extends AbstractConfigurationValidator {

    public EditorConfigurationValidator(@Nonnull ConfigurationKeeper configurationKeeper) {
