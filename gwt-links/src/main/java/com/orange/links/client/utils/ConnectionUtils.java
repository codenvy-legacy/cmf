...
public class ConnectionUtils {
    ...
    public static boolean isLinkDiagonal(Rectangle r1, Rectangle r2) {
        ...
        if ((r1.getCornerTopLeft().getLeft() > r2.getCornerBottomRight().getLeft()) &&
            (r1.getCornerTopLeft().getTop() > r2.getCornerBottomRight().getTop())
            || (r1.getCornerTopRight().getLeft() < r2.getCornerBottomLeft().getLeft()) &&
               (r1.getCornerTopRight().getTop() > r2.getCornerBottomLeft().getTop())
            || (r1.getCornerBottomRight().getLeft() < r2.getCornerTopLeft().getLeft()) &&
               (r1.getCornerBottomRight().getTop() < r2.getCornerTopLeft().getTop())
            || (r1.getCornerBottomLeft().getLeft() > r2.getCornerTopRight().getLeft()) &&
               (r1.getCornerBottomLeft().getTop() < r2.getCornerTopRight().getTop())
                ) {
            // Link is Diagonal
            return true;
        }
    ...
    public static Segment computeSegment(Rectangle r1, Rectangle r2) {
        ...
        if (isLinkDiagonal(r1, r2)) {
            ...
            } else if ((r1.getCornerTopRight().getLeft() <= r2.getCornerBottomLeft().getLeft()) &&
                       (r1.getCornerTopRight().getTop() >= r2.getCornerBottomLeft().getTop())) {
                p1 = r1.getCornerTopRight();
                p2 = r2.getCornerBottomLeft();
            } else if ((r1.getCornerBottomRight().getLeft() <= r2.getCornerTopLeft().getLeft()) &&
                       (r1.getCornerBottomRight().getTop() <= r2.getCornerTopLeft().getTop())) {
                p1 = r1.getCornerBottomRight();
                p2 = r2.getCornerTopLeft();
            } else if ((r1.getCornerBottomLeft().getLeft() >= r2.getCornerTopRight().getLeft()) &&
                       (r1.getCornerBottomLeft().getTop() <= r2.getCornerTopRight().getTop())) {
